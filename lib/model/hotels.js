...
const metadata = {
  ...
  toslove_wasorin: {
    name: 'トスラブ箱根和奏林',
    url: 'http://www.its-kenpo.or.jp/shisetsu/hoyou/chokuei/toslove_wasorin/index.html',
    image: {
  ...
  toslove_luana: {
    name: 'トスラブ館山ルアーナ',
    url: 'http://www.its-kenpo.or.jp/shisetsu/hoyou/chokuei/toslove_luana/index.html',
    image: {
  ...
  toslove_yuzawa: {
    name: 'トスラブ湯沢',
    url: 'http://www.its-kenpo.or.jp/shisetsu/hoyou/chokuei/toslove_yuzawa/index.html',
    image: {
  ...
  nakazawa: {
    name: '中沢ヴィレッジ',
    url: 'http://www.its-kenpo.or.jp/shisetsu/hoyou/chokuei/nakazawa.html',
    image: {
  ...
  katsuura: {
    name: 'ブルーベリーヒル勝浦',
    url: 'http://www.its-kenpo.or.jp/shisetsu/hoyou/chokuei/katsuura.html',
    image: {
  ...
  biwako: {
    name: '琵琶レイクオーツカ',
    url: 'http://www.its-kenpo.or.jp/shisetsu/hoyou/chokuei/biwako.html',
    image: {
  ...
  nasu: {
    name: 'ホテルハーヴェスト那須',
    url: 'http://www.its-kenpo.or.jp/shisetsu/hoyou/chokuei/nasu.html',
    image: {
  ...
  ito: {
    name: 'ホテルハーヴェスト伊東',
    url: 'http://www.its-kenpo.or.jp/shisetsu/hoyou/chokuei/ito.html',
    image: {
      path: '/images/ito.jpg',
  ...
  katsuyama: {
    ...
    url: 'http://www.its-kenpo.or.jp/shisetsu/hoyou/chokuei/katsuyama.html',
    image: {
  ...
  nanki: {
    name: 'ホテルハーヴェスト南紀田辺',
    url: 'http://www.its-kenpo.or.jp/shisetsu/hoyou/chokuei/nanki.html',
    image: {
  ...
  madarao: {
    name: 'ホテルハーヴェスト斑尾',
    url: 'http://www.its-kenpo.or.jp/shisetsu/hoyou/chokuei/madarao.html',
    image: {
  ...
  kyoto: {
    name: 'ホテル日航プリンセス京都',
    url: 'http://www.its-kenpo.or.jp/shisetsu/hoyou/chokuei/kyoto.html',
    image: {
  ...
  tateshina: {
    name: 'リゾートホテル蓼科',
    url: 'http://www.its-kenpo.or.jp/shisetsu/hoyou/chokuei/tateshina.html',
    image: {
  ...
  kyukaruizawa: {
    name: 'ホテルハーヴェスト旧軽井沢',
    url: 'http://www.its-kenpo.or.jp/shisetsu/hoyou/chokuei/kyukaruizawa.html',
    image: {
  ...
  kamakura: {
    name: '鎌倉パークホテル',
    url: 'http://www.its-kenpo.or.jp/shisetsu/hoyou/chokuei/kamakura.html',
    image: {
  ...
  iwaya: {
    name: '角間温泉　岩屋館',
    url: 'http://www.its-kenpo.or.jp/shisetsu/hoyou/chokuei/iwaya.html',
    image: {
...
class Hotels {
  ...
  static listNamesAndPaths(callback) {
    Hotels.get((err, hotels) => {
      if (err) {
        return callback(err);
      }
      return callback(null, hotels.data.map((hotel) => {
        return {
          name: hotel.name,
          path: '/hotels/' + hotel.key
        };
      }));
    });
  }
